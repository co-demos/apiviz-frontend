export const BasicDictionnary = {
  ...
  bo_delete_confirm_1a : {
    ...
    es : "¿ Estais seguro.a que quereis suprimir este elemento ?",
    de : "to do de",
    tr : "to do tr",
  ...
  bo_helper_2c : {
    ...
    es : "anadir nuevas llaves (keys) a sus propios riesgos",
    de : "to do de",
    tr : "to do tr",
  ...
  bo_helper_2d : {
    ...
    es : "anadir nuevos valores a las listas (pero tennga cuidado respetar al formato)",
    de : "to do de",
    tr : "to do tr",
  ...
  bo_duplicate_intro_1a : {
    ...
    es : "Podeis anadir un nuevo documento a la colección",
    de : "to do de",
    tr : "to do tr",
  ...
  bo_back : {
    ...
    es : "Volver a la pagina anterior",
    de : "to do de",
    tr : "to do tr",
